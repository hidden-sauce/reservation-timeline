(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ReservationStatusBar = {}));
    ...
    ***************************************************************************** */
    ...
    exports.ReservationStatusBar = class ReservationStatusBar extends s {
        render() {
            return x `
    <div>
      <slot></slot>
    ...
    `;
        ...
        constructor() {
            super();
            this.start = '2000-01-01 00:00:00';
            this.finish = '2000-01-01 00:00:01';
        }
        getPeriodSecond() {
            return (new Date(this.finish).getTime() - new Date(this.start).getTime());
        }
    };
    exports.ReservationStatusBar.styles = i$4 `
    div {
      display: flex;
      position: relative;
  ...
  `;
    __decorate([
        n$1()
    ], exports.ReservationStatusBar.prototype, "start", void 0);
    __decorate([
        n$1()
    ], exports.ReservationStatusBar.prototype, "finish", void 0);
    exports.ReservationStatusBar = __decorate([
        t$1('reservation-status-bar')
    ], exports.ReservationStatusBar);
    exports.ReservationStatusBarItem = class ReservationStatusBarItem extends s {
        constructor() {
            super(...arguments);
            this.item_start = '2023-11-13 15:00:00';
            this.item_finish = '2023-11-13 16:00:00';
            this.note_comment = '';
            this.title = '';
            this.custom_style = { 'background-color': 'blue' };
            this.position_style = { left: '0%', width: '0%' };
        }
        firstUpdated() {
        ...
        render() {
            return x `
<div id="container" style=${o(this.position_style)}>
<div id="bar">
${this.title}
</div>
${this.note_comment ? x `<span>${this.note_comment}</span>` : ''}
</div>

    `;
        }
    };
    exports.ReservationStatusBarItem.styles = i$4 `
    #container {
      position: absolute;
      top: 10%;
      left: 1%;
 ...
 `;
    __decorate([
        n$1()
    ], exports.ReservationStatusBarItem.prototype, "item_start", void 0);
    __decorate([
        n$1()
    ], exports.ReservationStatusBarItem.prototype, "item_finish", void 0);
    __decorate([
        n$1()
    ], exports.ReservationStatusBarItem.prototype, "note_comment", void 0);
    __decorate([
        n$1()
    ], exports.ReservationStatusBarItem.prototype, "title", void 0);
    __decorate([
        n$1({ type: Object })
    ], exports.ReservationStatusBarItem.prototype, "custom_style", void 0);
    exports.ReservationStatusBarItem = __decorate([
        t$1('reservation-status-bar-item')
    ], exports.ReservationStatusBarItem);
