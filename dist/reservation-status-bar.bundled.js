...
let ReservationStatusBar = class ReservationStatusBar extends s {
    render() {
        return x `
    <div>
      <slot></slot>
...
ReservationStatusBar.styles = i$4 `
    div {
      display: flex;
      position: relative;
...
__decorate([
    n$1()
], ReservationStatusBar.prototype, "start", void 0);
__decorate([
    n$1()
], ReservationStatusBar.prototype, "finish", void 0);
ReservationStatusBar = __decorate([
    t$1('reservation-status-bar')
], ReservationStatusBar);
let ReservationStatusBarItem = class ReservationStatusBarItem extends s {
    constructor() {
        super(...arguments);
...
ReservationStatusBarItem.styles = i$4 `
    #container {
      position: absolute;
      top: 10%;
      left: 1%;
...
__decorate([
    n$1()
], ReservationStatusBarItem.prototype, "item_start", void 0);
__decorate([
    n$1()
], ReservationStatusBarItem.prototype, "item_finish", void 0);
__decorate([
    n$1(String)
], ReservationStatusBarItem.prototype, "note_comment", void 0);
__decorate([
    n$1(String)
], ReservationStatusBarItem.prototype, "title", void 0);
__decorate([
    n$1({ type: Object })
], ReservationStatusBarItem.prototype, "custom_style", void 0);
ReservationStatusBarItem = __decorate([
    t$1('reservation-status-bar-item')
], ReservationStatusBarItem);

export { ReservationStatusBar, ReservationStatusBarItem };
